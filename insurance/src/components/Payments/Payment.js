  ...
  function postPayment(e) {
    ...
    fetch(postClaimAPI, {
      ...
      .catch(function (error) {
        return console.error("Error posting claim!", error);
      });
  }
  ...
  return (
    <main>
      <h1 className="font-bold text-xl my-5 text-center">
        Choose your insurance type and complete the payment securely.
      </h1>
      <form onSubmit={postPayment}>
        ...
        />
        <br />
        <label for="policyNumber" className="font-bold">
          Policy ID
        </label>
        <br />
        <input
          onChange={(e) => handleChange(e.target.value, "policy")}
          value={policy}
          className="box"
          type="text"
          name="policyNumber"
        ...
        />
        <br />
        <label for="amount" className="font-bold">
          Payment Amount
        </label>
        <br />
        <input
        ...
        {payMethod && (
          <div className="border-t-4 border-blue-500">
            ...
            <label for="cnum" className="font-bold">
              Card Number
            </label>
            <br />
            <input
            ...
            <br />
            <div className="div1">
              <label for="cardex" className="font-bold">
                Card expiry month
              </label>
              <br />
              <input
            ...
            <div className="div1">
              <label for="year" className="font-bold">
                Card expiry year
              </label>
              <br />
              <input
            ...
            <div className="div1">
              <label for="CVC" className="font-bold">
                Card CVC
              </label>
              <br />
              <input
        ...
        {!payMethod && (
          <div className="my-4 pt-3 border-t-4 border-blue-500">
            <p className="font-semibold mb-4">
              Please make the payment to the following account number:
              100035463673(CBE)
            </p>
            <label for="transactionId" className="font-semibold">
        ...
        <label for="automaticDeduction" className="font-semibold">
          Automatic Deduction for Civil Servants
        </label>
        <br />
        <input
          type="checkbox"
        ...
        <label for="automaticDeduction">
          Enable automatic deduction from salary
        </label>
        <br />
        <div className="flex gap-x-4 gap-y-2 flex-wrap my-4">
          {/* <h2 className='w-full font-bold'>Select Payment Method</h2> */}
          <button
            className="bg-blue-500 font-semibold text-white py-2 px-4 hover:bg-blue-600 rounded-md"
            onClick={() => {
              setPayMethod(true);
            }}
          >
          ...
          <a
            href="/portal/policy"
            className="bg-red-500 font-semibold text-white py-2 px-4 hover:bg-red-600 rounded-md cursor-pointer"
          >
            Cancel
          </a>
        </div>
